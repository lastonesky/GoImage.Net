...
public unsafe struct Block
{
    ...
    // Fixed-size buffer embedded directly in struct, no heap allocation
    public fixed int Data[BlockSize];
...
public static class Dct
{
    ...
    static unsafe void FdctCols(ref Block b)
    {
        fixed (int* d = b.Data)
        {
            for (int i = 0; i < 8; i++)
    ...
    static unsafe void FdctRows(ref Block b)
    {
        fixed (int* d = b.Data)
        {
            for (int i = 0; i < 8; i++)
    ...
    static unsafe void IdctRows(ref Block b)
    {
        fixed (int* d = b.Data)
        {
            for (int i = 0; i < 8; i++)
    ...
    static unsafe void IdctCols(ref Block b)
    {
        fixed (int* d = b.Data)
        {
            for (int i = 0; i < 8; i++)
